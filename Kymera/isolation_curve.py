...
#Load Real Data
data = pd.read_csv("./input/data_kymera1.csv")
data1 = data.drop(["c1","c2","c32"],axis=1)
y_true = data['c32']
X_train, X_test, y_train, y_test = train_test_split(data1, y_true, test_size=0.3, random_state=42)

#Load Synthetic Data
dataS = pd.read_csv("./input/data_synth_kymera1.csv")
dataS1 = dataS.drop(["c1","c2","c32"],axis=1)
yS_true = dataS['c32']
...
for i, (clf_name,clf) in enumerate(classifiers.items()):
    ...
    scn4_acc = accuracy_score(yS_test, y_predS) * 100
    scn4_ap = average_precision_score(yS_test, y_predS) * 100
    scn4_p = precision_score(yS_test, y_predS) * 100
    scn4_r = recall_score(yS_test, y_predS) * 100
    scn4_f = f1_score(yS_test, y_predS) * 100
    scn4_roc = roc_auc_score(yS_test, y_predS) * 100
    scn4_pr = AUPR * 100
...
# h1 = "Kymera1a_TP_IsolationForest_n_estimators=100_max_samples='auto'_contamination=0.01_max_features=1.0_bootstrap=False_n_jobs=-1_random_state=42_verbose=0" 
# h2 = "Kymera1a_TN_IsolationForest_n_estimators=100_max_samples='auto'_contamination=0.01_max_features=1.0_bootstrap=False_n_jobs=-1_random_state=42_verbose=0"
# h3 = "Kymera1a_FP_IsolationForest_n_estimators=100_max_samples='auto'_contamination=0.01_max_features=1.0_bootstrap=False_n_jobs=-1_random_state=42_verbose=0"
# h4 = "Kymera1a_FN_IsolationForest_n_estimators=100_max_samples='auto'_contamination=0.01_max_features=1.0_bootstrap=False_n_jobs=-1_random_state=42_verbose=0"
# h5 = "Kymera1a_Accuracy_IsolationForest_n_estimators=100_max_samples='auto'_contamination=0.01_max_features=1.0_bootstrap=False_n_jobs=-1_random_state=42_verbose=0"
# h6 = "Kymera1a_AveragePrecision_IsolationForest_n_estimators=100_max_samples='auto'_contamination=0.01_max_features=1.0_bootstrap=False_n_jobs=-1_random_state=42_verbose=0"
# h7 = "Kymera1a_Precision_IsolationForest_n_estimators=100_max_samples='auto'_contamination=0.01_max_features=1.0_bootstrap=False_n_jobs=-1_random_state=42_verbose=0"
# h8 = "Kymera1a_Recall_IsolationForest_n_estimators=100_max_samples='auto'_contamination=0.01_max_features=1.0_bootstrap=False_n_jobs=-1_random_state=42_verbose=0"
# h9 = "Kymera1a_F1-Score_IsolationForest_n_estimators=100_max_samples='auto'_contamination=0.01_max_features=1.0_bootstrap=False_n_jobs=-1_random_state=42_verbose=0"
# h10 = "Kymera1a_ROC-Area_IsolationForest_n_estimators=100_max_samples='auto'_contamination=0.01_max_features=1.0_bootstrap=False_n_jobs=-1_random_state=42_verbose=0"
# h11 = "Kymera1a_PR-Area_IsolationForest_n_estimators=100_max_samples='auto'_contamination=0.01_max_features=1.0_bootstrap=False_n_jobs=-1_random_state=42_verbose=0"
...
# myFile = open('result_isolationForest.csv', 'w')
# with myFile:
