...
# -*- coding: utf-8 -*-
"""
Created on Tue May 12 19:15:48 2020
...
classifiers = {
    "K-means Clustering": KMeans(n_clusters=2,random_state=42,algorithm="elkan",max_iter=10000,n_jobs=-1)
}
...
for i, (clf_name,clf) in enumerate(classifiers.items()):
    if clf_name == "Support Vector Machine":
        ...
        clf.fit(X_train)
        tic4 = time.time()
        elapsedtime1=tic4-tic3
        print("")
        print("Training Time Taken : "+str(elapsedtime1)+"seconds")
        y_predS = clf.predict(XS_test)
        tic5 = time.time()
...
h1 = "Paysim_synt_TP_K-meansClustering_n_clusters=2_random_state=42_algorithm='elkan'_max_iter=10000_n_jobs=-1"
h2 = "Paysim_synt_TN_K-meansClustering_n_clusters=2_random_state=42_algorithm='elkan'_max_iter=10000_n_jobs=-1"
h3 = "Paysim_synt_FP_K-meansClustering_n_clusters=2_random_state=42_algorithm='elkan'_max_iter=10000_n_jobs=-1"
h4 = "Paysim_synt_FN_K-meansClustering_n_clusters=2_random_state=42_algorithm='elkan'_max_iter=10000_n_jobs=-1"
h5 = "Paysim_synt_Accuracy_K-meansClustering_n_clusters=2_random_state=42_algorithm='elkan'_max_iter=10000_n_jobs=-1"
h6 = "Paysim_synt_AveragePrecision_K-meansClustering_n_clusters=2_random_state=42_algorithm='elkan'_max_iter=10000_n_jobs=-1"
h7 = "Paysim_synt_Precision_K-meansClustering_n_clusters=2_random_state=42_algorithm='elkan'_max_iter=10000_n_jobs=-1"
h8 = "Paysim_synt_Recall_K-meansClustering_n_clusters=2_random_state=42_algorithm='elkan'_max_iter=10000_n_jobs=-1"
h9 = "Paysim_synt_F1-Score_K-meansClustering_n_clusters=2_random_state=42_algorithm='elkan'_max_iter=10000_n_jobs=-1"
h10 = "Paysim_synt_ROC-Area_K-meansClustering_n_clusters=2_random_state=42_algorithm='elkan'_max_iter=10000_n_jobs=-1"
#h11 = "Paysim_synt1_PR-Area_K-meansClustering_n_clusters=2_random_state=42_algorithm="elkan"_max_iter=10000_n_jobs=-1"
...
cs = np.concatenate((tp,tn,fp,fn,acc,ap,p,r,f,roc))
myFile = open('paysim_k-MeansClustering.csv', 'w')
with myFile:
