...
# -*- coding: utf-8 -*-
"""
Created on Tue May 12 16:40:37 2020
...
precision, recall, _ = precision_recall_curve(y_test, model_probs)
auc_score = auc(recall, precision)
print('Decision Tree PR AUC: %.3f' % auc_score)
...
# calculate the precision-recall auc
precision, recall, _ = precision_recall_curve(yS_test, model_probsS)
auc_score = auc(recall, precision)
print('Logistic PR AUC: %.3f' % auc_score)
# plot precision-recall curves
plot_pr_curve(yS_test, model_probs)
...
# calculate the precision-recall auc
precision, recall, _ = precision_recall_curve(y_test, naive_probsS)
auc_score = auc(recall, precision)
print('No Skill PR AUC: %.3f' % auc_score)

# calculate the precision-recall auc
precision, recall, _ = precision_recall_curve(y_test, model_probsS)
auc_score = auc(recall, precision)
print('Logistic PR AUC: %.3f' % auc_score)
# plot precision-recall curves
plot_pr_curve(y_test, model_probsS)
...
h1 = "Paysim_synt1_TP_SVC_probability=True_kernel='linear'"
h2 = "Paysim_synt1_TN_SVC_probability=True_kernel='linear'"
h3 = "Paysim_synt1_FP_SVC_probability=True_kernel='linear'"
h4 = "Paysim_synt1_FN_SVC_probability=True_kernel='linear'"
h5 = "Paysim_synt1_Accuracy_SVC_probability=True_kernel='linear'"
h6 = "Paysim_synt1_AveragePrecision_SVC_probability=True_kernel='linear'"
h7 = "Paysim_synt1_Precision_SVC_probability=True_kernel='linear'"
h8 = "Paysim_synt1_Recall_SVC_probability=True_kernel='linear'"
h9 = "Paysim_synt1_F1-Score_SVC_probability=True_kernel='linear'"
h10 = "Paysim_synt1_ROC-Area_SVC_probability=True_kernel='linear'"
h11 = "Paysim_synt1_PR-Area_SVC_probability=True_kernel='linear'"
